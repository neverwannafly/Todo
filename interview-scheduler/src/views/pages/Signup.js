import { ServerPreifx, GREEN_NOTICE, BLUE_NOTICE } from "../../services/Config.js";
      ...
      $.ajax({
        ...
        success: async (data) => {
          if (data.success) {
            SetUser(data.user);
            await Redirect('/');
            await IssueNotice(`Hello ${GetUser().username}!`, BLUE_NOTICE);
          }
          else {
            await IssueNotice(data.error, GREEN_NOTICE);
          }
        }
      })
    });
